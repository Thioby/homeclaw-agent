...
BASE_SYSTEM_PROMPT = (
    ...
    "- create_dashboard(dry_run=true first!): Create new dashboard\n"
    "- update_dashboard(dry_run=true first!): Update existing dashboard\n"
    "- delete_dashboard(dry_run=true first!): Delete dashboard\n\n"
    "WEB TOOLS:\n"
    ...
    "- ALWAYS call with dry_run=true first — this only generates a PREVIEW, nothing is saved!\n"
    "- When dry_run=true result comes back, tell user: 'Here is the dashboard preview' and show the config\n"
    "- Do NOT say 'created' or 'updated' — it is only a preview! Wait for user to confirm\n"
    "- The UI shows a confirm button — user will click it to apply. You do NOT call dry_run=false yourself\n"
...
SYSTEM_PROMPT_LOCAL = {
    ...
    "content": (
        ...
        "- create_dashboard(dry_run=true first!)\n"
        "- update_dashboard(dry_run=true first!)\n"
        "- delete_dashboard(dry_run=true first!)\n\n"
        "WEB:\n"
