...
BASE_SYSTEM_PROMPT = (
    ...
    "- 'Remind me to check the garden at 8am' → scheduler add, cron='0 8 * * *', one_shot=true\n"
    "- 'Check energy usage every hour' → scheduler add, cron='0 * * * *'\n"
    "- 'Every day at 20:00 check weather' → scheduler add, cron='0 20 * * *'\n"
